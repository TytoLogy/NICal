...
for F = 1:Nfreqs
	...
	if cal.Side == 1 || cal.Side == 3
		...
		%-------------------------------------------------------
		% synthesize the F_1 sine wave;
		[S_1, stimspec.RMS, stimspec.phi] = ...
									syn_calibrationtone2(cal.StimDuration, ...
																	iodev.Fs, freq_1, 0, 'L');
		% synthesize the F0 sine wave;
		[S0, stimspec.RMS, stimspec.phi] = ...
									syn_calibrationtone2(cal.StimDuration, ...
																	iodev.Fs, freq, 0, 'L');
		% synthesize the F1 sine wave;
