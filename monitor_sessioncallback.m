...
% global VtoPa Gain fcoeffa fcoeffb ...
% 		 Lacq Racq Lfft Rfft H SweepPoints

% read data from ai object
tmpdata = event.Data;
% Lacq = filtfilt(fcoeffb, fcoeffa, sin2array(tmpdata(:, 1)', 5, obj.Rate));
% Racq = filtfilt(fcoeffb, fcoeffa, sin2array(tmpdata(:, 2)', 5, obj.Rate));
